...
- Any literature-traced parameter must include a source note in `docs/literature_queue.md`.
- Keep dependencies minimal until a notebook or numerical routine truly needs them.
- If coherence cannot be recovered, shrink the model before expanding the explanation.
