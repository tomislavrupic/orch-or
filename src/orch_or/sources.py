...
SOURCE_REGISTRY: dict[str, Source] = {
    ...
    "microtubule_structure_nogales_1998": Source(
        ...
        authors="Eva Nogales, Sharon G. Wolf, Kenneth H. Downing",
        year=1998,
        url="https://doi.org/10.1038/34465",
        status="literature_traced",
        usage="Primary tubulin-dimer structural reference: Nature 391, 199-203; DOI 10.1038/34465.",
    ),
    "microtubule_lattice_nogales_1999": Source(
        ...
        authors="Eva Nogales, Michael Whittaker, Ronald A. Milligan, Kenneth H. Downing",
        year=1999,
        url="https://doi.org/10.1016/S0092-8674(00)80961-7",
        status="literature_traced",
        usage="Primary microtubule lattice reference: Cell 96(1), 79-88; DOI 10.1016/S0092-8674(00)80961-7.",
    ),
    "tubulin_atomic_lowe_2001": Source(
        ...
        status="literature_traced",
        usage="Refined alpha beta-tubulin coordinates: Journal of Molecular Biology 313(5), 1045-1057; DOI 10.1006/jmbi.2001.5077.",
    ),
    "tryptophan_superradiance_2024": Source(
        source_id="tryptophan_superradiance_2024",
        ...
        usage="Quantum-yield and superradiance diagnostics for tryptophan mega-networks.",
    ),
    "photoprotection_architectures_2024": Source(
        source_id="photoprotection_architectures_2024",
        ...
        status="supported_microphysics",
        usage="Quantum-yield scaling and disorder robustness diagnostics for neuroprotein architectures.",
    ),
    "superradiant_excitonic_states_2018": Source(
        source_id="superradiant_excitonic_states_2018",
        title="On the existence of superradiant excitonic states in microtubules",
        authors="G. L. Celardo, M. Angeli, P. Kurian, T. J. A. Craddock",
        year=2018,
        url="https://arxiv.org/abs/1809.03438",
        status="supported_microphysics",
        usage="Superradiant and supertransfer diagnostics for tryptophan chromophore lattices.",
    ),
